from PyQt5.QtWidgets import QApplication, QMainWindow, QTextEdit, QStackedWidget, QWidget, QLineEdit, QGridLayout, QVBoxLayout, QHBoxLayout
...
class InitialScreen(QWidget):
    ...
    def __init__(self, parent=None):
        super(InitialScreen, self).__init__(parent)
